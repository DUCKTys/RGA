...
global.zenzkey = 'b3f68624fd' //Register Atau Beli Di zenzapis.xyz

//===> SESUAIKAN DENGAN KEBUTUHAN MU
global.ownerNumber = ['6281359053674'] //Ganti Jadi Nomer mu Biar Fitur Ownernya Bisa Dipake
global.Rowner = '6281359053674' //Owner Utama
global.ownerName = 'RGA' //Ganti Jadi Namamu
global.packname = 'BOT WA' //Ganti Jadi Nama Botmu
global.author = 'RGA' //Ganti Jadi Namamu
global.prefa = ['','.','#','!'] //Ilangin Prefix Yang '' Kalau Gamau No Prefix
global.sessionName = 'sesi' //Saran Gausah Diganti Lagi
global.webme = 'https://github.com/DUCKTys' //Ganti Jadi Bebas Web Sosmed Mu
...
//===> SESUAIKAN DENGAN KEBUTUHAN MU 
global.mess = {
admin: '*Kamu bukan admin! karna admin hanyalah alat*',
botAdmin: '*Jadiin gw admin lah gblk!*',
botOwner: '*Lu saha ajg!*',
group: '*Khusus group gblk!*',
private: '*Khusus pc ngaf!*',
wait: '*Sabar ajg!*',
done: '*Done!*',
prem: '*Khusus User Premium, kalau mau premium chat owner ngaf*'
}
